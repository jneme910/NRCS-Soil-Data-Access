...
SELECT DISTINCT mukey, ROUND (SUM (CO_SOC_0_20) over(PARTITION BY mukey) ,3) AS SOC_0_20, 
ROUND (SUM (CO_SOC_20_50) over(PARTITION BY mukey),3) AS SOC_20_50, 
ROUND(SUM (CO_SOC_50_100) over(PARTITION BY mukey),3)  AS SOC_50_100 
FROM #SOC3
