...
FROM  legend 
INNER JOIN  mapunit ON mapunit.lkey=legend.lkey AND areasymbol = 'IL001'
...
ROUND (SUM (adj_comp_pct *  HayAlf811UofIbase) OVER(PARTITION BY mukey),1),0) AS     HayAlf811UofIbaseadj            ,              
