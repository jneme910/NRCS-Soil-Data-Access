...
INNER JOIN cosoilmoist AS cospt8 ON cospt8.comonthkey=co8.comonthkey AND co8.comonthkey=comonth.comonthkey AND soimoiststat="wet")  AS min_soimoistdepb_l,
...
INNER JOIN cosoilmoist AS cospt12 ON cospt12.comonthkey=co12.comonthkey AND co12.comonthkey=comonth.comonthkey  #AND ISNULL (soimoiststat, "moist") !="wet"
)   AS wtbottom_r_moist
FROM legend
...
DEFINE apparent		IF ISNULL(max_soimoistdepb_h) THEN "---" ELSE 
					...
					IF wtbottom_l_moist >  min_soimoistdept_l THEN "Perched2"  ELSE 
										IF wtbottom_l  == max_soimoistdepb_l THEN "Apparent3" 
					ELSE "Perched4".
