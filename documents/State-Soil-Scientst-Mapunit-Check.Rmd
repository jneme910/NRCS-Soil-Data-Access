---
title: "Search by Map Unit or Map Unit Symbol"
...
## Search by map unit name in multiple states
```{SQL}
SELECT musym, muname, areasymbol, areaname
FROM legend
...
## Search map unit symbols used in a state
