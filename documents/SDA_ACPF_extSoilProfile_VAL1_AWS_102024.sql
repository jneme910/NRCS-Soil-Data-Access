...
DROP TABLE IF EXISTS #acpf3
DROP TABLE IF EXISTS #acpf4
DROP TABLE IF EXISTS #aws150
DROP TABLE IF EXISTS #depthtest
DROP TABLE IF EXISTS  #acpfwtavg
DROP TABLE IF EXISTS  #alldata
DROP TABLE IF EXISTS #alldata2
DROP TABLE IF EXISTS #alldata3


SELECT areASymbol, areaname, mapunit.mukey, mapunit.musym, nationalmusym, mapunit.muname, mukind, muacres, aws0150wta
INTO #main
FROM legend
INNER JOIN mapunit on legend.lkey=mapunit.lkey AND legend.areasymbol = 'WI025'
...
#main.mukey,   
muname, #main.musym,  nationalmusym,  mukind,
 MU_AWC_WEIGHTED_AVG0_150, aws0150wta, 
